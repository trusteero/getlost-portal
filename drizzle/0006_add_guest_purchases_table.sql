...
CREATE INDEX IF NOT EXISTS `guest_purchase_email_idx` ON `guest_purchase`(`guestEmail`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `guest_purchase_status_idx` ON `guest_purchase`(`status`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `guest_purchase_feature_idx` ON `guest_purchase`(`featureType`);--> statement-breakpoint
